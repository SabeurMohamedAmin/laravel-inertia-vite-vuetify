                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a
                        ...
                        class="scale-100 p-6 bg-white dark:bg-gray-800/50 
                                ...
                                dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg
                                shadow-2xl shadow-gray-500/20 dark:shadow-none flex
                                motion-safe:hover:scale-[1.01] transition-all duration-250
                                focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-smleading-relaxed">
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900dark:text-white">Laracasts</h2>
                    ...
                    <div class="flex items-center gap-4">
                        <a
                            ...
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                                class="-mt-px mr-1 w-5 h-5 stroke-gray-400 
                                        dark:stroke-gray-600 group-hover:stroke-gray-600
                                        dark:group-hover:stroke-gray-400"
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
